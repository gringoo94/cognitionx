...
const DATA: EmotionCategory[] = [
  ...
  { label: ["Мы рядом", "с другими"], color: "#b0cce0", tc: "#1a4060",
    emotions: ["Сравнение страданий", "Границы", "Сочувствие", "Эмпатия", "Жалость", "Сострадание"],
    hint: "Эмоции, возникающие в ответ на боль других людей.",
    slug: "my-ryadom-s-drugimi" },
  { label: ["Сердце", "открыто"], color: "#e8a898", tc: "#7a2a1a",
    emotions: ["Любовь", "Отсутствие любви", "Защитная реакция", "Предательство", "Доверие к себе", "Разбитое сердце", "Эмоц. захлёстывание", "Обида", "Доверие"],
