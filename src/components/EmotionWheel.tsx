...
const DATA: EmotionCategory[] = [
  ...
  { label: ["Мы рядом", "с другими"], color: "#b0cce0", tc: "#1a4060",
    emotions: ["Сравнительное страдание", "Границы", "Сочувствие", "Эмпатия", "Жалость", "Сострадание"],
    hint: "Эмоции, возникающие в ответ на боль других людей." },
  { label: ["Сердце", "открыто"], color: "#e8a898", tc: "#7a2a1a",
    emotions: ["Любовь", "Нелюбовь", "Защита", "Предательство", "Самодоверие", "Разбитое сердце", "Захлёст", "Боль", "Доверие"],
  ...
  { label: ["Всё идёт", "не по плану"], color: "#b0c890", tc: "#3a5020",
    emotions: ["Фрустрация", "Покорность", "Обескураженность", "Сожаление", "Ожидания", "Разочарование", "Скука"],
