...
export const homeFaq = [
  ...
  },
  {
    ...
    answer: "Бесплатная встреча-знакомство — 20 минут (без обязательств). Полная первая консультация — 25 € (50 минут). Регулярная сессия — 30 €. Пакет из 4 сессий — 100 € (25 € за сессию). Оплата до сессии.",
  },
  {
