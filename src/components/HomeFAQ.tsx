...
export const homeFaq = [
  ...
  },
  {
    ...
    answer: "Первая консультация — 2 500 ₽. Регулярные сессии — 4 000 ₽. Длительность — 50 минут. Оплата после каждой сессии.",
  },
  {
  ...
  },
  {
    ...
    answer: "Напишите мне в Telegram (@darrroo04) или заполните форму на сайте. Я свяжусь с вами в течение дня и мы договоримся о времени.",
  },
];
