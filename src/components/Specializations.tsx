...
import { ArrowRight, AlertCircle, CloudRain, Flame, Heart, Shield, Sparkles, BookOpen, Wine } from "lucide-react";
...
const specs = [
  ...
  {
    title: "Зависимости",
    desc: "Алкоголь, вещества, поведенческие зависимости — когда хочется остановиться, но не получается",
    icon: Wine,
    slug: "addiction",
  },
];
