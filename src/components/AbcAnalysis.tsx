    ...
    return (
      <div className="space-y-12">
        ...
        <section className="space-y-3">
          <h2 className="text-xl font-semibold">Три типичные ошибки</h2>
          <ul className="space-y-2 text-sm">
            {[
              "Смешивать A и B. «Меня проигнорировали» — это уже интерпретация, а не факт. Факт звучит проще: «Он не ответил на сообщение в течение дня». Чем точнее A, тем понятнее, где именно подключается мысль.",
              "Останавливаться на первой мысли. «Он злится» — обычно лишь верхний слой. Если задать себе вопрос «А если это правда — что это говорит обо мне и о ситуации?», под ним почти всегда обнаруживается что-то более глубокое: «значит, со мной что-то не так», «значит, меня снова отвергнут». Работать имеет смысл именно с этим.",
              "Подменять проверку мысли «позитивным мышлением». Шаг D — это не уговоры в духе «всё будет хорошо», а честный взгляд на доказательства. Если мысль подтверждается фактами, задача меняется: не переформулировать её, а решить, что с этим делать.",
            ].map((t, i) => (
              <li
                key={i}
        ...
        <section className="text-center space-y-4 py-4">
          ...
          <h2 className="text-2xl font-bold">Попробуйте на своей ситуации</h2>
          <p className="text-sm text-muted-foreground max-w-md mx-auto">
            Вспомните недавний эпизод, который оставил заметный эмоциональный след, — и пройдите по
            пяти шагам. На это уходит 5–10 минут.
          </p>
