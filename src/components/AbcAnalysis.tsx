...
const steps: {
...
}[] = [
  {
    ...
    prompt: "Что именно произошло?",
    hint: "Только факты. Представьте, что снимаете происходящее видеокамерой — без оценок, только то, что можно было бы увидеть.",
    placeholder: "Например: коллега не ответил на моё сообщение в течение дня.",
    color: "text-sky-400",
  },
  {
    key: "B",
    title: "Мысль",
    subtitle: "Belief",
    prompt: "Что вы подумали в этот момент?",
    hint: "Что промелькнуло в голове сразу после события? Часто звучит как: «Он злится», «Значит, я плохой», «Это никогда не закончится».",
    placeholder: "Например: «Я сказал что-то не то и теперь он на меня злится».",
  ...
  },
  {
    ...
    hint: "Назовите эмоцию и её интенсивность от 0 до 100. Что произошло в теле? Какое появилось желание действовать?",
    placeholder: "Например: тревога 75%, ком в горле, хочется проверять телефон каждую минуту.",
    color: "text-rose-400",
  },
  {
    key: "D",
    ...
    prompt: "Насколько эта мысль точна?",
    hint: "Какие есть факты ЗА и ПРОТИВ этой мысли? Есть ли альтернативные объяснения? Что бы вы сказали другу с такой мыслью?",
    placeholder: "Например: фактов, что он злится — нет. Возможно, он занят, на встрече, забыл телефон. Раньше тоже бывали паузы — это ничего не значило.",
  ...
  },
  {
    ...
    title: "Итог",
    subtitle: "New effect",
    prompt: "Какая мысль точнее — и что вы чувствуете теперь?",
    hint: "Новая мысль не обязана быть оптимистичной. Она должна быть точной. Снова оцените эмоцию от 0 до 100 — обычно интенсивность снижается.",
    placeholder: "Например: «Я не знаю, почему он молчит, и это нормально». Тревога 35%.",
      ...
      <div className="space-y-12">
        ...
        >
          <h1 className="text-3xl md:text-4xl font-bold tracking-tight">
            <span className="text-primary">ABC-анализ:</span> почему мы чувствуем то, что чувствуем
          </h1>
          <p className="text-muted-foreground leading-relaxed">
            Большинство из нас уверены, что именно события заставляют нас переживать.
            Но между событием и эмоцией всегда есть невидимый посредник — наши мысли и убеждения.
            ABC-анализ помогает его найти.
          </p>
          <blockquote className="rounded-xl border border-border bg-card p-5 text-sm italic text-muted-foreground">
            «Людей расстраивают не вещи, а мнения об этих вещах».
        ...
        <section className="space-y-5">
          ...
          <p className="text-sm text-muted-foreground leading-relaxed">
            Модель была разработана психологом Альбертом Эллисом в 1950-х и стала основой
            когнитивно-поведенческой терапии. Она раскладывает любой эмоциональный эпизод на
            пять компонентов.
          </p>
            ...
            {steps.map((s) => (
              ...
              >
                ...
                <div className="text-[10px] text-muted-foreground/70 mt-1 leading-tight">
                  {s.key === "A" && "Что произошло — голые факты"}
                  {s.key === "B" && "Что вы подумали"}
                  {s.key === "C" && "Что вы почувствовали"}
                  {s.key === "D" && "Насколько мысль точна"}
                  {s.key === "E" && "Более точная мысль"}
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="rounded-xl border border-primary/20 bg-primary/5 p-5">
            ...
            <p className="text-sm leading-relaxed text-foreground/90">
              Событие (A) не вызывает эмоции (C) напрямую. Между ними всегда стоит убеждение (B) —
              интерпретация, которую мы придаём происходящему. Именно она определяет, что мы
              почувствуем. Это означает, что, изменив интерпретацию, мы можем изменить и своё
              эмоциональное состояние — не подавляя чувства, а работая с их источником.
            </p>
          </div>
        </section>
