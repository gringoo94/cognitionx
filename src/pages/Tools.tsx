...
const tools = [
  {
    ...
    description: "Оцените выраженность симптомов в четырёх плоскостях: мысли, эмоции, тело и поведение. Помогает увидеть связь между ними.",
    icon: Brain,
  ...
  },
  {
    ...
    description: "Отслеживайте настроение и планируйте активности, чтобы выйти из спирали избегания при депрессии.",
    icon: Zap,
      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        ...
        >
          ...
          <p className="mt-3 text-muted-foreground max-w-2xl">
            Бесплатные интерактивные инструменты когнитивно-поведенческой и схема-терапии. Каждый — с теорией, примером и шагом для самостоятельной работы.
          </p>
        </motion.div>
