...
const usaFaq = [
  ...
  },
  {
    ...
    answer: "Можно, но их мало, запись на недели вперёд, а цена — $150–250 за сессию. Онлайн-формат со мной доступнее (40 €), не привязан к городу и строится на доказательных методах — КПТ и схема-терапии.",
  },
  {
  ...
  },
  {
    ...
    answer: "Первый шаг — бесплатная 20-минутная встреча-знакомство. Это не терапия: обсудим запрос, ответите на вопросы, решите, подходим ли мы друг другу. Дальше — диагностическая сессия 50 минут (40 €).",
  },
  {
