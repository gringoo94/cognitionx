...
const expatFaq = [
  ...
  },
  {
    ...
    answer: "Первая сессия — это знакомство и диагностика. Мы обсудим ваш запрос, я задам уточняющие вопросы, проведу первичную оценку состояния и предложу план работы. Длительность — 50 минут.",
  },
  {
