...
const expatFaq = [
  ...
  },
  {
    ...
    answer: "Первый шаг — бесплатная 20-минутная встреча-знакомство. Это не терапия, а возможность обсудить ваш запрос, задать вопросы и понять, подходим ли мы друг другу. После этого, если решите продолжить, начнём полноценную диагностическую сессию (50 мин, 35 €).",
  },
  {
...
const LandingPageEuropa = () => (
  <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
    ...
    <main>
      ...
      <section className="max-w-7xl mx-auto px-6 pt-10 md:pt-16 pb-16">
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
          <div className="text-center md:text-left order-2 md:order-1">
            ...
            >
              {["Бесплатное знакомство · 20 мин", "Сессия 50 мин · 35 €", "Zoom · из любой страны"].map((t) => (
      ...
      {/* ── About ── */}
      <About
        text="Меня зовут Дмитрий. Я клинический психолог, работаю в КПТ и схема-терапии. Работаю онлайн с русскоязычными экспатами по всей Европе из Кишинёва (EET, UTC+2/+3)."
        quote="«Эмоции формируются на родном языке — и работать с ними на чужом всё равно что чинить часы в перчатках.»"
        chips={["КПТ", "Схема-терапия", "На русском языке", "Онлайн по всей Европе"]}
      />
