...
const expatFaq = [
  ...
  },
  {
    ...
    answer: "Первый шаг — бесплатная 20-минутная встреча-знакомство. Это не терапия, а возможность обсудить ваш запрос, задать вопросы и понять, подходим ли мы друг другу. После этого, если решите продолжить, начнём полноценную диагностическую сессию (50 мин, 40 €).",
  },
  {
      ...
      <section className="max-w-7xl mx-auto px-6 pt-10 md:pt-16 pb-16">
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
          <div className="text-center md:text-left order-2 md:order-1">
            ...
            >
              {["Бесплатное знакомство · 20 мин", "Сессия 50 мин · 40 €", "Zoom · из любой страны"].map((t) => (
