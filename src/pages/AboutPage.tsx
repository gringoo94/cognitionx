...
const personSchema = {
  ...
  description: "Психолог, практикующий когнитивно-поведенческую терапию. Работаю с депрессией, тревогой, паническими атаками, выгоранием.",
  knowsAbout: [
...
const qualifications = [
  ...
  "Специализация в когнитивно-поведенческой терапии (КПТ)",
...
const AboutPage = () => (
  <div className="min-h-screen bg-background text-foreground">
    <SEOHead
      title="Обо мне — Психолог Дмитрий Яцко | КПТ терапия"
      description="Психолог Дмитрий Яцко — когнитивно-поведенческая терапия. Образование, подход, принципы работы. Помощь при депрессии, тревоге, панических атаках."
      path="/about"
