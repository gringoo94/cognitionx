...
const seoSections = [
  ...
  {
    h2: "Психологический возраст: насколько зрелая ваша личность",
    body: (
      <>
        <Link to="/tools/tests/psychological-age" className="text-primary hover:underline">
          Тест на психологический возраст
        </Link>{" "}
        — 12 вопросов о зрелости, ответственности и эмоциональной регуляции. На основе концепции
        субъективного возраста (Kastenbaum, 1972). Полезен как точка входа в терапию: показывает,
        где «застряли» детские стратегии и какие взрослые компетенции стоит развивать.
      </>
    ),
  },
  {
